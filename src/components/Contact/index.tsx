    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='mailto:ph9530338@gmail.com' >
                ...
                <BoxContact target="blank"  href='https://api.whatsapp.com/send?phone=5512988243129' >
                ...
                <BoxCV href={"https://drive.google.com/file/d/1XPihJrTnjQlOaWD5AmSl3DfJ_4-VIrrk/view?usp=sharing"} download="Pedro Henrique - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContainerSocialMedias>
                    <SocialMedia target="blank"  href='https://www.linkedin.com/in/pedro-henrique-de-souza-128484214'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank"  href='https://github.com/pedryn'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank" href='https://instagram.com/_souza_pedroh'>
